...
export declare type ItemsProfile = {
    [key: string]: {
        startRender: number;
        endRender: number | null;
    };
};
export declare type itemsDataProfile = {
...
export declare type requestType = 'request' | 'profile';
...
export declare enum CAFActionTypes {
    __INIT__ = "__INIT__",
    SET_USER = "SET_USER",
...
export declare type CAFAction = initAction | setUserAction | setLocationAction | setAddFieldsAction | addTagAction | removeTagAction | beginProfileAction | endEmptyProfileAction | beginRenderAction | endRenderAction | resetRenderStateAction | addRequestAction | setPushApiAction | setPushTimerAction | setPushStoreRequestTimerAction | setPushStoreProfileTimerAction | setLimitRequestsAction;
export {};
